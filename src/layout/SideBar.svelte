  ...
  <div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul>
      ...
      <li class="relative px-6 py-3">
        ...
        {#if pages_dropdown}
          <div in:fly="{{y:-10, easing:cubicOut, duration:200}}"
...
<!-- Backdrop -->
{#if $current}
  <div in:fly="{{easing:cubicOut, duration:150, delay:20}}" out:fly="{{easing:cubicOut, duration:150, delay:20}}">
    <div class="fixed inset-0 flex items-end bg-black bg-opacity-50 sm:items-center sm:justify-center"></div>
  </div>
{/if}

{#if $current}
  <div in:fly="{{x: -20, easing:cubicOut, duration:150}}" out:fly="{{x:-20, easing:cubicOut, duration:150}}">
    <ClickOutside on:clickoutside={close} exclude={exclude}
        on:keydown={({keyCode}) => keyCode === 27 ? close(): ''}>
      <div class="fixed inset-y-0 z-30 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden">
